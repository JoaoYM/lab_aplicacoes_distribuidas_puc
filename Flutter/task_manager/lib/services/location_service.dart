...
class LocationService {
  ...
  Future<Position?> getLocationFromAddress(String address) async {
    try {
      ...
      if (locations.isNotEmpty) {
        ...
        // Usar o Position diretamente do geolocator em vez de criar manualmente
        // Primeiro obtemos a posição atual para ter todos os dados necessários
        ...
        if (currentPosition != null) {
          ...
          // Se não conseguirmos a posição atual, criar uma posição básica
          return Position(
            latitude: location.latitude,
            longitude: location.longitude,
            timestamp: DateTime.now(),
  ...
  // Método alternativo simplificado para obter apenas coordenadas do endereço
  Future<LocationCoordinates?> getCoordinatesFromAddress(String address) async {
    try {
      ...
      print('Erro ao buscar coordenadas do endereço: $e');
    }
    return null;
  }
}

// Classe auxiliar para coordenadas simples
